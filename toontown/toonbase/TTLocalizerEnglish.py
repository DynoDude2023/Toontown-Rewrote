...
lToonHQ = 'Toon HQ'
lToonResistance = 'Toon Resistance'
...
QuestDialogDict = {160: {GREETING: '',
 ...
 14000: {GREETING: '',
       QUEST: "Hello! Flippy told me that you need to visit a special toon!\x07Visit the Taskforce Leader Ripley and see what she wants!",
       INCOMPLETE_PROGRESS: TheCogs + 'Visit Ripley to find out!',
 ...
 14001: {GREETING: '',
       ...
       LEAVING: QuestsDefaultLeaving},
 14002: {GREETING: '',
       QUEST: 'There it is! let me get this set for you...\x07Wait...WAIT\x07Theres a pinkslip attached to it? This is what it says...\x07"ALL COGS. I, the Chairman. Leader of this nation, have big plans."\x07"There will be a meeting at the COGS: BOARD OFFICE 54775. Do NOT, DISAPOINT!" - The Chairman\x07_avName_, They might be planning something worse than doomsday!\x07Go to Resistance Ranger Pancake and see if he can help!',
       INCOMPLETE_PROGRESS: TheCogs + 'Hurry, speak to Pancake!',
       INCOMPLETE_WRONG_NPC: 'Who?',
       COMPLETE: QuestsDefaultComplete,
       LEAVING: QuestsDefaultLeaving},
 14003: {GREETING: '',
...
FireCogTitle = 'HIRES LEFT:%s\nHIRE WHICH COG?'
FireCogLowTitle = 'HIRES LEFT:%s\nNOT ENOUGH!'
...
SuitV2InvasionBegin1 = lToonResistance + ': Watch out toons, the CEO has released a Executive Memo!!!'
SuitV2InvasionBegin2 = lToonResistance + ': Version 2.0 %s have taken over Toontown!!!'
...
BossbotRTCongratulations = "You did it! You've demoted the C.E.O.!\x07Here, take these Hiring Pappers the C.E.O. left behind.\x07With it you'll be able to hire Cogs in a battle."
