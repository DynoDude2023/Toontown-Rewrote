...
class DistributedBossCogAI(DistributedAvatarAI.DistributedAvatarAI):
    ...
    def getBattleExperience(self):
        return BattleExperienceAI.getBattleExperience(self.involvedToons, self.toonExp, self.toonSkillPtsGained,
    ...
    def invokeSuitPlanner(self, buildingCode, skelecog, customDept=None):
        if customDept:
            dept = customDept
        else:
            dept = self.dna.dept
