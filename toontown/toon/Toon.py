...
def loadDialog():
    ...
    crocDialogueFiles = ('AV_crocodile_short', 'AV_crocodile_med', 'AV_crocodile_long', 'AV_crocodile_question', 'AV_crocodile_exclaim', 'AV_crocodile_howl')
    global CrocDialogueArray
    for file in crocDialogueFiles:
        CrocDialogueArray.append(base.loader.loadSfx(loadPath + file + '.ogg'))
...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def getDialogueArray(self):
        ...
        if animalType == 'dog':
            ...
            dialogueArray = CrocDialogueArray
        else:
            dialogueArray = None
