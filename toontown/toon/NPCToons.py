...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    accNPCS = [3, 5]
    if npcId in accNPCS:
       canonicalZoneId, name, dnaType, gender, protected, type, access = desc
    else:
       access = 0
       canonicalZoneId, name, dnaType, gender, protected, type = desc
    if type == NPC_REGULAR:
        if access:
            npc = DistributedNPCToonAI.DistributedNPCToonAI(air, npcId, questCallback=questCallback, accList=access)
        else:
...
NPCToonDict = {20000: (-1,
 ...
 2: (11800,
        "Ripley",
        ('sls', 'ms', 'm', 'f', 24, 0, 24, 24, 111, 27, 98, 27, 45, 27),
        'f',
        1,
        NPC_REGULAR),
 3: (11800,
        "Doctor Bumpy",
        ('bss', 'ms', 'm', 'm', 20, 0, 4, 4, 111, 27, 98, 27, 41, 27),
        'm',
        1,
        NPC_REGULAR,
        [6,56,11,0]),
 4: (11800,
        "Bonnie Bubbles",
        ('bss', 'ls', 'm', 'f', 17, 0, 17, 17, 111, 27, 98, 27, 45, 27),
        'f',
        1,
        NPC_REGULAR),
 5: (11800,
        "Pancake",
        ('mss', 'ms', 'm', 'm', 10, 0, 10, 10, 111, 27, 98, 27, 41, 27),
        'm',
        1,
        NPC_REGULAR,
        [20,55,18,0]),
