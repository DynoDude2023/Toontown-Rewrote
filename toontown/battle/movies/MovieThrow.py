...
def __throwPie(throw, delay, hitCount):
    ...
    if hitSuit:
        ...
        if kbBonus > 0:
            ...
            suitInterval = Sequence(ActorInterval(suit, 'seizecontrol', startFrame=7, endFrame=23),
                                    Parallel(ActorInterval(suit, 'seizecontrol', startFrame=24, endFrame=0, playRate=0.85),
                                    MovieUtil.createSuitStunInterval(suit, 0.3, 1.3)))
        else:
            suitInterval = Sequence(ActorInterval(suit, 'seizecontrol', startFrame=7, endFrame=23), ActorInterval(suit, 'seizecontrol', startFrame=24, endFrame=0, playRate=0.85))
