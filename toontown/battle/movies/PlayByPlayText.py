...
class PlayByPlayText(OnscreenText.OnscreenText):
    ...
    def getShowIntervalCheat(self, text, duration):
        return Sequence(Func(self.hide), Func(self.setFg, (1, 0.5, 0, 1.0)), Wait(duration * 0.3), Func(self.setText, text), Func(self.show), Wait(duration * 0.7), Func(self.hide))

    def getShowIntervalDesc(self, text, duration):
        return Sequence(Func(self.hide), Func(self.setWordwrap, None), Func(self.setPos, 0.0, 0.65), Func(self.setScale, 0.1), Func(self.setFg, (1, 1, 0, 1.0)), Wait(duration * 0.3), Func(self.setText, text), Func(self.show), Wait(duration * 0.7), Func(self.hide))
