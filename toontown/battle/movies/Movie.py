...
class Movie(DirectObject.DirectObject):
    ...
    def play(self, timestamp, callback):
        ...
        suitAttacks2, suitCam2 = self.__doSuitAttacksBefore()
        suitAttacks, suitCam = self.__doSuitAttacksAfter()
        if suitAttacks2:
            playTrack.append(suitAttacks2)
            cameraTrack.append(suitCam2)
    ...
    def __genSuitAttackDicts(self, toons, suits, suitAttacks):
        for suitAttack in suitAttacks:
            ...
            if attack != NO_ATTACK:
                ...
                attackDict['beforeToons'] = suitAttack[SUIT_BEFORE_TOONS_COL]
    ...
    def __doSuitAttacksBefore(self):
